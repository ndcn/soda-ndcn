...
example_lipidomics = function(name,
  ...
  r6$indices$group_col = group_column
  r6$indices$type_col = type_column
  r6$indices$batch_col = batch_column
  r6$set_indexed_meta()
  r6$set_raw_meta()

  # r6$tables$raw_meta = r6$tables$raw_meta[r6$tables$raw_meta$Batch %in% c(1,2),]

  type_vector = r6$tables$imp_meta[, type_column]
  ...
  r6$set_raw_data(batch_effect_correction = "None",
...
example_proteomics = function(name = 'prot_example',
                              id = NA,
                              slot = NA,
                              group_column = 'Group_type',
                              type_column = 'Sample_type',
                              data = './examples/multiomics/proteomics_2.tsv',
                              meta = './examples/multiomics/metadata.csv',
                              param_file = NULL) {
...
example_transcriptomics = function(name = 'trns_example', id = NA, slot = NA, group_column = 'Group_type', type_column = 'Sample_type', data = './examples/multiomics/transcriptomics_2_genename_test.tsv', meta = './examples/multiomics/metadata.csv', param_file = NULL) {
